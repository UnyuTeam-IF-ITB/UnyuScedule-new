 ...
 */
@Entity
@Table(name = "jadwal_detail")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "JadwalDetail.findAll", query = "SELECT j FROM JadwalDetail j"),
    @NamedQuery(name = "JadwalDetail.findByIdSlot", query = "SELECT j FROM JadwalDetail j WHERE j.idSlot = :idSlot"),
    @NamedQuery(name = "JadwalDetail.findByTanggal", query = "SELECT j FROM JadwalDetail j WHERE j.tanggal = :tanggal")})
public class JadwalDetail implements Serializable {
    ...
    public JadwalDetail(Long idSlot) {
        this.idSlot = idSlot;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof JadwalDetail)) {
            return false;
        }
        JadwalDetail other = (JadwalDetail) object;
    ...
    public String toString() {
        return "com.kel6.schedule.entities.JadwalDetail[ idSlot=" + idSlot + " ]";
    }

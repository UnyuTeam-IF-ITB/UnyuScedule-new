...
public class KetersediaanDosen implements Serializable {
    ...
    @NotNull
    @GeneratedValue(strategy = GenerationType.SEQUENCE,generator = "ketersediaan_seq")
    @SequenceGenerator(name = "ketersediaan_seq",sequenceName = "seq_ketersediaan_dosen",allocationSize = 1)

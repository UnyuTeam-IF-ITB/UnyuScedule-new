    ...
    public class KetersediaanController implements Serializable{
        ...
        private List<KetersediaanDosen> listItemToDelete;
    ...
    //        listSelected.add(newKS);
        ...
        public void addEvent(ActionEvent actionEvent) {
            ...
            if(event.getId() == null){
                ...
                listItemToDelete = ejbFacade.getKetersediaanByNikDate(getAuthenticated(), this.event.getStartDate());
                if(listItemToDelete!=null){
                    for(i=0;i<listItemToDelete.size();i++){
                        ejbFacade.remove(listItemToDelete.get(i));
                    }
                }
